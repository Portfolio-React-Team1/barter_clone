        ...
        <div className="guard">
          <form onSubmit={submitHandler}>
            <div className="form__item">
              <label className="form__label form__label--2">
                {" "}
            ...
            <Link to="/">
              ...
              <button
                className={
                  formValid ? "auth_signup-active" : "auth_signup-submit"
                }
              >
                Log in
              </button>
            ...
            <div className="que containerr">
              <div>
                <p>
                  {" "}
                  Don't have an account?{" "}
                  <Link className="already form__link--highlight" to="/signup">
                    {" "}
                    Register{" "}
                  </Link>{" "}
                </p>{" "}
